...
\begin{table}[H]
    ...
    \begin{tabular}{cccc}
        ...
        438             &    434           & 422.319            & 3e-05 \\
        443             &    460           & 450.296            & 3e-05 \\
        471             &    473           & 456            & 3e-05\\
        492             &    486           & 506.146            & 3e-05\\
        587             &    563           & 561.841            & 3e-05\\
        667             &    640           & 645.058            & 3e-05\\
        \hline          
    \end{tabular}
...
Tras el estudio de la difracción y la espectroscopía del Helio, se ha podido validar el modelo de Fraunhofer para la determinación de parámetros físicos. La anchura de la rendija calculada ($26.25 \mu m$) concuerda con las especificaciones técnicas habituales, y los parámetros de red obtenidos han permitido identificar las líneas principales del espectro del Helio con un error mínimo.

\vspace{0.5cm}
Las discrepancias observadas en las redes de mayor densidad de líneas sugieren que la aproximación de ángulos pequeños pierde validez, requiriendo el uso de la relación trigonométrica completa para mejorar la precisión en futuros estudios.
