...
Estas medidas se han tomado con un calibre milimetrado. 

\vspace{0.2cm}

Este mismo procedimiento se ha realizado tanto para la rendija simple como para la red de difracción. 
...
los ángulos respecto a un ángulo incial de referencia y con estos datos se han realizado los cálculos.
